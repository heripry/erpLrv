  ...
  function index () {
      $rs = DB::select("select case Level when 0 then Name
                    ...
                    from (
                                 ...
                                 Select menuID,  code, isnull(GroupID,0) as GroupID, isnull(GroupName,'') as GroupName, name, isLeaf, Level, Ordering, inActive, Status from 
                                (
      ...
      $data = array('menu'  => $data['menu'],
       ...
       // var_dump($data);
      return view('admin/mod_pelanggan/pelanggan_view', $data);
  }
...
function tambahdataDetail(Request $request){
    ...
    $rs = DB::insert("INSERT INTO wmenu (ParentID, Code, Name, inActive, Icon, isLeaf, Level, Ordering) VALUES ('$ParentID', '$Code', '$Name', '$inActive', '$Icon', '$isLeaf', '$Level', '$Ordering')");
  }
