...
<div class="content-wrapper">
  <section class="content-header">
      <h1><div class="besar">Sales Invoice (Add)</div></h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <table id="example" class="table table-bordered" cellspacing="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td>Term</td>
                    <td><input type="text" id="txtTerm" class="form-control" disabled="disabled"></td>
                  </tr>
                  <tr>
                    <td>Customer</td>
                    ...
                    <td rowspan="2"><textarea id="txtNotes" class="form-control"></textarea></td> 
                  </tr>
                  <tr>
                    <td>Reff Number</td>
...
<table class="table" border="0">
  <tr>  
    ...
    <td align="right" width="20px"><input id="txtRounded" type="number" value="0" /></td>
  </tr>
  <tr>  
    <td colspan="4"></td>
    <td align="right">Discount</td>
    <td align="right" width="20px"><input id="txtDiscount" type="number"  value="0"/></td>
  </tr>
  <tr>  
    <td colspan="4"></td>
