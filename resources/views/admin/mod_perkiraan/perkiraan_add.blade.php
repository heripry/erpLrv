...
<title>Add Master Perkiraan</title>
 ...
 function closeModal (){
  ...
  $("#Simpan").click(function(){
                ...
                var tinActive = 0;
                  ...
                  $.ajax({
                    type: "POST",
                    url:  "{{ route('admin/perkiraan/tambahdataDetail') }}",
                    data: {"_token": "{{ csrf_token() }}", Perkiraan: $('#txtPerkiraan').val(), GroupPerkiraan: $('#cbGroubPerkiraan').val(), Keterangan: $('#txtKeterangan').val(), inActive: tinActive, CabID: $('#cbCabID').val(), Kelompok: $('#cbKelompok').val(), GenOrDet: $('#cbGenOrDet').val(), MataUang: $('#cbMataUang').val(), DebOrKre: $('#cbDebOrKre').val(), NoNeraca: $('#txtNoNeraca').val(), KodeBukti: $('#txtKodeBukti').val()},
                    dataType: 'html',
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Add Master Perkiraan</h3>
            </div>
              ...
              <div class="box-body"> 
               <div class="row">
                ...
                <div class="col-md-2 form-group mb-3">
                  <input type="text" id="txtPerkiraan" class="form-control" >
                </div>
                ...
                <div class="col-md-2 form-group mb-3">
                  <div class="input-group">
                       <input type="text" id="cbGroubPerkiraan" class="form-control" readonly="readonly">
               ...
               <div class="row">
                ...
                <div class="col-md-8 form-group mb-3">
                  <input type="text" id="txtKeterangan" class="form-control" >
                </div>
               </div>
               ...
               <div class="row">
                ...
                <div class="col-md-4 form-group mb-3">
                  <input type="text" id="txtNoNeraca" class="form-control" >
                </div>
               </div>  
