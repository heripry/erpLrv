          ...
          <div class="box">
            ...
            <div class="box-body">
             ...
             <div class="row">
                ...
                <div class="col-xs-2">
                     <button type="button" class="btn btn-block btn-default" onclick="javascript:window.location.href='menu/form_tambahdata'">Add</button>
                </div>
             </div>  
            </div>
...
<table id="example" class="table table-bordered table-striped" cellspacing="0" width="100%" >
       ...
       <tr>
        ...
        <tr>
          ...
          <td><i class="fa <?php echo $list->Icon; ?>"></i></td>
          <td><?php echo $list->isLeaf; ?></td>
