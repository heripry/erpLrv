  ...
  function cekPhone(){
   ...
   function cekDataSimpan() {
        //if cektexbox apakah kosong 
             if ($('#txtNoKTP').val() == '' ){alert('KTP Harus Di Isi'); $('#txtNoKTP').focus();}
              ...
              else if ($('#txtCustomerNameNew').val() == '') {alert('Nama Harus Diisi'); $('#txtCustomerNameNew').focus();}
                ...
                $('#Simpan').prop('disabled', true);
                        ...
                        $.ajax({
                                       ...
                                       success: function(sData){
                                             ...
                                             alert('Silahkan cek email anda untuk konfirmasi selanjutnya untuk login.'); window.location.replace("{{ route('home') }}");
                           ...
                           <form action="#">
                               <div class="sign__input-wrapper mb-25">
                                 ...
                                 <div class="sign__input">
                                    ...
                                    <div id="lblKTP" style="display: none;"></div>
                                 </div>
                              </div>
                              ...
                              <div class="sign__input-wrapper mb-25">
                               ...
                               <div class="sign__input-wrapper mb-25">
                                 ...
                                 <div class="sign__input">
                                    ...
                                    <div id="lblPhone" style="display: none;"></div>
                                 </div>
                              </div>
                             ...
                             <!--   <div class="sign__input-wrapper mb-25">
                              ...
                              <div class="sign__input-wrapper mb-10">
                                 <h5>Re-Password</h5>
                                 <div class="sign__input">
                                    <input type="password" id="txtConfirmPassword" placeholder="Re-Password">
                                    <i class="fal fa-lock"></i>
                                 </div>
                              </div>
